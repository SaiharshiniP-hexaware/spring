...
public class InterestController {
	...
	public String calcComp(@Valid @ModelAttribute("ibean") Interest form, BindingResult br, Model model) {
		if(br.hasErrors())
			return "InterestFrm";
		double res = form.getAmt() * Math.pow((1 + form.getRate() / 100), form.getYears()) - form.getAmt();
